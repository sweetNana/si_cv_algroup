        ...
        <div class="col-12">
            <div class="card card-success">
                <div class="card-header">
                    <h3 class="card-title">Barang Belum Pernah Ada</h3>
                ...
                <div class="card-body">
                    <form action="{{url('staf/barang/addProcess_tidak')}}" method="post" enctype="multipart/form-data" onsubmit="return confirm('Apakah Data Akan Disimpan ? ')">
                        @csrf
                        <div class="row">
                            <div class="col-1"></div>
                            <div class="col-10">
                                    ...
                                    <div class="col-6 border-right">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" name="id_barang" class="form-control" value="{{ $kode_barangs }}" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" name="nama_barang" class="form-control nama_barang @error('nama_barang') is-invalid @enderror" value="{{ old('nama_barang') }}" required>
                                                @error('nama_barang')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" name="satuan" class="form-control satuan @error('satuan') is-invalid @enderror" value="{{ old('satuan') }}" required>
                                                @error('satuan')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
